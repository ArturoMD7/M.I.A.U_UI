...
class _UserPostsModalState extends State<UserPostsModal> {
  ...
  String get mediaUrl => apiService.mediaUrl;
  ...
  Future<void> _fetchUserPosts() async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
            ...
            postsList.map<Map<String, dynamic>>((post) {
              ...
              final List<Map<String, dynamic>> postImages =
                  imagesList
                      .where(
                        (img) =>
                            (img as Map<String, dynamic>)['idPost'] ==
                            postMap['id'],
                      )
                      .cast<Map<String, dynamic>>()
                      .toList();

              return {...postMap, 'pet': pet, 'images': postImages};
            }).toList();
        ...
        throw Exception(
          "Error al cargar publicaciones: ${response.statusCode}",
        );
      }
    } catch (e) {
      setState(() {
  ...
  void _filterPosts(int tabIndex) {
    setState(() {
      ...
      switch (tabIndex) {
        ...
        case 1: // Perdidas
          displayedPosts =
              allPosts.where((post) => post['postType'] == 'lost').toList();
          break;
        case 2: // Adopción
          displayedPosts =
              allPosts.where((post) => post['postType'] == 'adoption').toList();
          break;
      }
    });
  }
  ...
  Widget _buildPostCard(BuildContext context, Map<String, dynamic> post) {
    ...
    final List<Map<String, dynamic>> images =
        (post['images'] as List<dynamic>).cast<Map<String, dynamic>>();
